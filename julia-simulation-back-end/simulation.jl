...
simulate_1!(paras,::Val{1}) = simulation_Heat_exchanger(Th = paras["仿真参数"]["热流体温度(K)"],
																												Tc = paras["仿真参数"]["冷流体温度(K)"],
...
simulate_1!(paras,::Val{2}) = simulation_Heat_exchanger(Th = paras["仿真参数"]["热流体温度(k)"],
																												Tc = paras["仿真参数"]["冷流体温度(k)"],
																												Qh = paras["仿真参数"]["热流体流量(kg/s)"],
																												Qc = paras["仿真参数"]["冷流体流量(kg/s)"],
																												L = paras["仿真参数"]["换热管长度(m)"],
