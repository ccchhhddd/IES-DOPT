...
> = {
  ...
  controler_analysis_editor: () => import('./controler/analysis/editor/index.vue'),
  controler_analysis_painting: () => import('./controler/analysis/painting/index.vue'),
  ...
  optimization_analysis: () => import('./optimization/analysis/index.vue'),
