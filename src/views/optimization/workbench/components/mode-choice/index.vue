              ...
              <n-tab-pane v-for="(val, key, ind) in simulationParamsInput" :name="key">
                ...
                <n-collapse :accordion="true">
                  ...
                  <n-space vertical justify="space-between" size="large" style="margin-bottom: 10px">
                    ...
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['运行天数']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>运行天数：</template>
                    </n-input-number>
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['氢气生产用水成本(元/kg)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>氢气生产用水成本(元/kg)：</template>
                    </n-input-number>
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['氢气销售价格(元/kg)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>氢气销售价格(元/kg)：</template>
                    </n-input-number>
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['天然气价格(元/Nm³)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>天然气价格(元/Nm³)：</template>
                    </n-input-number>
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['单次运输氢气费用(元/次)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>单次运输氢气费用(元/次)：</template>
                    </n-input-number>
                    <n-input-number
                      v-if="items !== '1' && items !== '3'&& key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['最大投资金额(元)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>最大投资金额(元)：</template>
                    </n-input-number>
                    <n-input-number
                      v-if="items !== '1' && items !== '2'&& key == '经济性分析参数'"
                      v-model:value="simulationParamsInput['经济性分析参数']['目标最小制氢量(kg)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>目标最小制氢量(kg)：</template>
                    </n-input-number>
                  </n-space>
              ...
              <n-tab-pane v-for="(val, key, ind) in optParamsInput" :name="key">
                ...
                <n-collapse :accordion="true">
                  ...
                  <n-space vertical justify="space-between" size="large" style="margin-bottom: 10px">
                    ...
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['运行天数']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>运行天数：</template>
                    ...
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['氢气生产用水成本(元/kg)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>氢气生产用水成本(元/kg)：</template>
                    ...
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['氢气销售价格(元/kg)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>氢气销售价格(元/kg)：</template>
                    ...
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['天然气价格(元/Nm³)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>天然气价格(元/Nm³)：</template>
                    ...
                    <n-input-number
											v-if="key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['单次运输氢气费用(元/次)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>单次运输氢气费用(元/次)：</template>
                    ...
                    <n-input-number
                      v-if="items !== '1' && items !== '3'&& key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['最大投资金额(元)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>最大投资金额(元)：</template>
                    ...
                    <n-input-number
                      v-if="items !== '1' && items !== '2'&& key == '经济性分析参数'"
                      v-model:value="optParamsInput['经济性分析参数']['目标最小制氢量(kg)']"
                      :parse="parse"
                      :format="format"
                    >
                      <template #prefix>目标最小制氢量(kg)：</template>
...
function simulationToServer() {
  ...
  input['经济性分析参数'] = simulationParamsInput.value['经济性分析参数'];
  request
