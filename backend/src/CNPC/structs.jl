...
# Parameters:
- `capacity`: 额定容量， kg
- `unit_capacity`: 单罐容量， kg
- `machine_number`: 罐组数量
- `η_charging`: 充气效率
- `charging_limit`: 充气阈值限制
- `life_year`: 使用年限，年
- `cost_initial`: 初始成本，元/kg
- `cost_OM`: 年运维成本，元/kg
- `cost_replace`: 更换成本，元/kg
- `staff_number`: 人员数
"""
Base.@kwdef mutable struct HydrogenStorage <: RenewableEnergyMachine
    capacity::Float64 = 1e7
    unit_capacity::Float64 = 1.0
    machine_number::Int64 = 1
...
"""
Base.@kwdef mutable struct PumpedStorage <: RenewableEnergyMachine
    capacity::Float64 = 1e7
    hours::Float64 = 6.0
    unit_capacity::Float64 = 650
    machine_number::Int64 = 1
...
"""
Base.@kwdef mutable struct CompressAirEnergyStorage <: RenewableEnergyMachine
    capacity::Float64 = 15000
    hours::Float64 = 6.0
    unit_capacity::Float64 = 650
    machine_number::Int64 = 1
...
"""
Base.@kwdef mutable struct ElectrochemicalEnergyStorage <: RenewableEnergyMachine
    capacity::Float64 = 15000
    hours::Float64 = 6.0
    unit_capacity::Float64 = 650
    machine_number::Int64 = 1
...
- `price_to_grid`: 上网电价，元/kWh
- `peak_price_from_grid`: 高峰购电电价，元/kWh
- `valley_price_from_grid`: 低谷购电电价，元/kWh
- `flat_price_from_grid`: 平段购电电价，元/kWh
...
Base.@kwdef mutable struct Financial
    ...
    peak_price_from_grid::Float64 = 0.563009
    valley_price_from_grid::Float64 = 0.264641
    flat_price_from_grid::Float64 = 0.413825
